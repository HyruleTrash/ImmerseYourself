...
public class WiiMoteInterpreter : MonoBehaviour
{
    public UnityEvent onWiiRemoteUpdate;
    ...
    private void Update()
    {
        ...
        if (Time.time - lastUpdate >= UPDATE_INTERVAL)
        {
            ...
            rotation = new Vector3(-motionControls.z * 90f, 0f, -motionControls.x * 90f);
            
            lastUpdate = Time.time;
            
            onWiiRemoteUpdate.Invoke();
        }
    }
