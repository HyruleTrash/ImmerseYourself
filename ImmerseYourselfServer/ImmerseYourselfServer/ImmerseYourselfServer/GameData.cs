...
public class GameData
{
    ...
    public PlayedMiniGamesList playedMiniGames = new();
    public PlayedMiniGamesList playedMiniGamesTemp = new();
    public MiniGames lastPlayedMiniGame;

    public class PlayedMiniGamesList
    {
